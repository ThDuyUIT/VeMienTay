                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          ...
                          children: [
                            Text(
                              _detailTicketController.itemTicket.departureTime,
                              style: const TextStyle(
                                  fontSize: 18,
                                  color: Colors.black,
                                  fontFamily: 'Roboto bold'),
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          ...
                          children: [
                            Text(
                                _accountController.accountInformation!.fullName,
                                style: const TextStyle(
                                  fontFamily: 'Roboto bold',
                                  fontSize: 18,
                                )),
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            children: [
                              Text(
                                _detailTicketController.ticket.statusPayment ==
                                        '0'
                                    ? 'Unpaid'
                                    : 'Paid',
                                style: const TextStyle(
                      ...
                      ? Container(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            icon: Image(
                                width: 40,
                                height: 40,
                                image: AssetImage('assets/images/gg_map.png')),
                            label: Text(
                              'Google Map',
